...
def post(headers, address, mime_type, timeout, data=None, files=None, cookies=None):
    """
    封装post请求
    :param headers: 请求头
    :param address: 请求地址
...
def get(headers, address, data, timeout=8, cookie=None):
    """
    get 请求
    :param headers: 请求头
    :param address:  请求地址
